...
#deprecated
def load_crypto_data_from_file(filename: str) -> pd.DataFrame:
    """
...
def data_train_test_from_file(filename: str, test=False) -> Union[Tuple[pd.DataFrame, pd.Series],Tuple[pd.DataFrame, pd.DataFrame, pd.Series, pd.Series] ]:
    df = load_crypto_data_from_file(filename)
